...
test('GET `/api/creditcards/activation/:id`', async (t) => {
    ...
    test('activate a credit card successfully', async (t) => {
        ...
        const activateCreditCard = await fastify.inject({
            method: "GET",
        ...
        t.equal(activateCreditCard.statusCode, 200)
    })

    test('fail to activate a credit card because the credit card is not found', async (t) => {
        ...
        const activateCreditCard = await fastify.inject({
            method: "GET",
            url: `/api/creditcards/activation/0`,
            headers: {
                authorization: `Bearer ${token}`
            }
        })

        t.equal(activateCreditCard.statusCode, 404)
    })

    test('fail to activate a credit card because the role is incorrect', async (t) => {
        ...
        t.equal(activateCreditCard.statusCode, 401)
    })
